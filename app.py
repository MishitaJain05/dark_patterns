...
def process_link(link):
    ...
    # s= Service("/home/saumil/Documents/scraping/chromedriver-linux64/")
...
def analysis():
    if request.method=='POST':
        ...
        if is_url_scrapable(link):
            ...
            # class_mapping = dict(zip(label_encoder.transform(label_encoder.classe), label_encoder.classe))
            ...
            # # Add link to each dictionary in the list
            # for record in frequency_dict:
            #     record['link'] = "https://"+link.split('/')[2]

            # # Insert the list of dictionaries into MongoDB
            # db.inventory.insert_many(frequency_dict)
...
#             dark_pattern_noticed = request.form['dark_pattern_noticed']
        
#             db.inventory.insert_one({
#                 'email': email,
#                 'url': url,
#                 'dark_pattern_noticed': dark_pattern_noticed,
#             })
